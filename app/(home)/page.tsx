  ...
  return (
    <main className="flex flex-col min-h-screen w-full bg-white font-family-inter">
      ...
      <footer className="bg-secondary px-4">
        <div className="container mx-auto max-w-[1300px] pt-[92px] pb-[25px] flex flex-col gap-[95px]">
          <div className="flex">
            ...
            <div className="ml-[88px] flex flex-col gap-6">
            ...
            <div className="ml-[100px] flex flex-col gap-6">
              <h3 className="text-white text-2xl leading-33-6 tracking-0-38 font-family-cardo">
                Utility Pages
              </h3>
              <nav className="pl-[11px] flex flex-col gap-[9px] [&>a]:flex [&>a]:items-center [&>a]:gap-[9px] [&>a]:text-size-18 [&>a]:leading-30-6 [&>a]:tracking-0-18 [&>a]:font-family-inter [&>a]:text-quinary">
          ...
          <div>
            <p className="text-center text-quinary text-size-17 leading-25-5 tracking-0-17 font-family-inter [&>a]:text-white">
              © Drafted by <Link href="/">VictorFlow</Link> - Powered by Link{" "}
